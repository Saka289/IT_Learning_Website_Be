...
public class ExamAnswerService : IExamAnswerService
{
    ...
    public async Task<ApiResult<bool>> CreateRangeExamAnswer(IEnumerable<ExamAnswerCreateDto> examAnswerCreateDtos)
    {
        var result = _mapper.Map<IEnumerable<ExamAnswer>>(examAnswerCreateDtos);
        await _examAnswerRepository.CreateRangeExamAnswer(result);
        return new ApiResult<bool>(true, "Create Range Answer Successfully");
    }
